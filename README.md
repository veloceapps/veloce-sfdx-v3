...
veloce-sfdx-v3/0.0.15 darwin-x64 node-v16.15.1
$ sfdx --help [COMMAND]
USAGE
  $ sfdx COMMAND
...
...
- [`sfdx veloce:data:pull -p <string> [-m <string>] [-w <string>] [-s <string>] [-o <string>] [-R <string>] [-v <string>] [-u <string>] [--apiversion <string>] [--json] [--loglevel trace|debug|info|warn|error|fatal|TRACE|DEBUG|INFO|WARN|ERROR|FATAL]`](#sfdx-velocedatapull--p-string--m-string--w-string--s-string--o-string--r-string--v-string--u-string---apiversion-string---json---loglevel-tracedebuginfowarnerrorfataltracedebuginfowarnerrorfatal)
...
## `sfdx veloce:data:pull -p <string> [-m <string>] [-w <string>] [-s <string>] [-o <string>] [-R <string>] [-v <string>] [-u <string>] [--apiversion <string>] [--json] [--loglevel trace|debug|info|warn|error|fatal|TRACE|DEBUG|INFO|WARN|ERROR|FATAL]`

Retrieves data from Salesforce org and stores it in provided folder as CSVs

```
USAGE
  $ sfdx veloce:data:pull -p <string> [-m <string>] [-w <string>] [-s <string>] [-o <string>] [-R <string>] [-v
...
_See code: [src/commands/veloce/data/pull.ts](https://github.com/veloceapps/veloce-sfdx-v3/blob/v0.0.15/src/commands/veloce/data/pull.ts)_
...
_See code: [src/commands/veloce/data/push.ts](https://github.com/veloceapps/veloce-sfdx-v3/blob/v0.0.15/src/commands/veloce/data/push.ts)_
...
_See code: [src/commands/veloce/debug/list.ts](https://github.com/veloceapps/veloce-sfdx-v3/blob/v0.0.15/src/commands/veloce/debug/list.ts)_
...
_See code: [src/commands/veloce/debug/logs.ts](https://github.com/veloceapps/veloce-sfdx-v3/blob/v0.0.15/src/commands/veloce/debug/logs.ts)_
...
_See code: [src/commands/veloce/debug/push.ts](https://github.com/veloceapps/veloce-sfdx-v3/blob/v0.0.15/src/commands/veloce/debug/push.ts)_
...
_See code: [src/commands/veloce/debug/start.ts](https://github.com/veloceapps/veloce-sfdx-v3/blob/v0.0.15/src/commands/veloce/debug/start.ts)_
...
_See code: [src/commands/veloce/debug/stop.ts](https://github.com/veloceapps/veloce-sfdx-v3/blob/v0.0.15/src/commands/veloce/debug/stop.ts)_
...
_See code: [src/commands/veloce/debug/watch.ts](https://github.com/veloceapps/veloce-sfdx-v3/blob/v0.0.15/src/commands/veloce/debug/watch.ts)_
...
_See code: [src/commands/veloce/fixref.ts](https://github.com/veloceapps/veloce-sfdx-v3/blob/v0.0.15/src/commands/veloce/fixref.ts)_
...
_See code: [src/commands/veloce/login.ts](https://github.com/veloceapps/veloce-sfdx-v3/blob/v0.0.15/src/commands/veloce/login.ts)_
...
_See code: [src/commands/veloce/source/pack.ts](https://github.com/veloceapps/veloce-sfdx-v3/blob/v0.0.15/src/commands/veloce/source/pack.ts)_
...
_See code: [src/commands/veloce/source/pull.ts](https://github.com/veloceapps/veloce-sfdx-v3/blob/v0.0.15/src/commands/veloce/source/pull.ts)_
...
_See code: [src/commands/veloce/source/push.ts](https://github.com/veloceapps/veloce-sfdx-v3/blob/v0.0.15/src/commands/veloce/source/push.ts)_
